...
-- AddForeignKey
ALTER TABLE "barbershopservices" ADD CONSTRAINT "barbershopservices_barbershopId_fkey" FOREIGN KEY ("barbershopId") REFERENCES "barbershops"("id") ON DELETE CASCADE ON UPDATE CASCADE;
